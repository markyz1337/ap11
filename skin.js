...
// Filename: 1simpleex_v6.ggsk
// Generated 2024-06-07T21:12:18
...
function pano2vrSkin(player,base) {
	...
	player.addVariable('stertscreen', 2, true);
	...
	this.addSkin=function() {
		...
		hs+='border : 8px solid rgba(104,104,104,0.607843);';
		hs+='cursor : default;';
		hs+='height : 30px;';
		hs+='left : -25px;';
		hs+='position : absolute;';
...
me.player.on("positionchanged", () => {
	me._float_cursor.ggUpdateCursor();
		...
		el=me._meree=document.createElement('div');
		el.ggId="meree";
		el.ggDx=0;
		el.ggDy=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._meree.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._meree.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((player.getVariableValue('stertscreen') == false))
			)
			{
				newLogicStateVisible = 0;
			}
			...
			if (me._meree.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._meree.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._meree.style[domTransition]='';
				if (me._meree.ggCurrentLogicStateVisible == 0) {
					me._meree.style.visibility="hidden";
					me._meree.ggVisible=false;
				}
				else {
					me._meree.style.visibility=(Number(me._meree.style.opacity)>0||!me._meree.style.opacity)?'inherit':'hidden';
					me._meree.ggVisible=true;
				}
			}
		}
		me._meree.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._meree.appendChild(me._rectangle_2);
		...
		me._button_1.logicBlock_position = function() {
			...
			if (me._button_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._button_1.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 0s';
				if (me._button_1.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					this.ggDy = 115;
					me._button_1.ggUpdatePosition(true);
				}
				else {
					me._button_1.ggDx=0;
					me._button_1.ggDy=84;
					me._button_1.ggUpdatePosition(true);
				}
			}
		}
		me._button_1.logicBlock_scaling = function() {
			...
			if (me._button_1.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._button_1.ggCurrentLogicStateScaling == 0) {
					me._button_1.ggParameter.sx = 2;
					me._button_1.ggParameter.sy = 2;
					me._button_1.style[domTransform]=parameterToTransform(me._button_1.ggParameter);
				}
				else {
					me._button_1.ggParameter.sx = 0.5;
					me._button_1.ggParameter.sy = 0.5;
					me._button_1.style[domTransform]=parameterToTransform(me._button_1.ggParameter);
				}
			}
		}
		me._button_1.onclick=function (e) {
			...
			player.setVariableValue('stertscreen', false);
		}
		...
		me._meree.appendChild(me._button_1);
		...
		me._text_2.logicBlock_position = function() {
			...
			if (me._text_2.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._text_2.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 0s';
				if (me._text_2.ggCurrentLogicStatePosition == 0) {
					this.ggDx = 0;
					this.ggDy = -90;
					me._text_2.ggUpdatePosition(true);
				}
				else {
					me._text_2.ggDx=0;
					me._text_2.ggDy=-41;
		...
		me._text_2.logicBlock_scaling = function() {
			...
			if (me._text_2.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._text_2.ggCurrentLogicStateScaling == 0) {
					me._text_2.ggParameter.sx = 2;
					me._text_2.ggParameter.sy = 2;
		...
		me._text_2.ggUpdatePosition=function (useTransition) {
			...
			this.ggTextDiv.style.left=((502-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		me._meree.appendChild(me._text_2);
		me.divSkin.appendChild(me._meree);
		...
		me._controller.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getVariableValue('stertscreen') == true))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		me._controller.logicBlock_alpha = function() {
			...
			if (me._controller.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				if (me._controller.ggCurrentLogicStateAlpha == 0) {
					...
					me._controller.style.opacity=0.8;
				}
				else {
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
		...
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
			''+
			''+
			''+
			''+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			...
			''+
		...
		me._text_1.logicBlock_position = function() {
			...
			if (me._text_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._text_1.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 0s';
		...
		me._text_1_1.logicBlock_position = function() {
			...
			if (me._text_1_1.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._text_1_1.style[domTransition]='left 0s, top 0s, ' + cssPrefix + 'transform 0s';
	...
	player.addListener('changenode', function(args) { me._float_cursor.logicBlock_visible();me._meree.logicBlock_visible();me._controller.logicBlock_position();me._controller.logicBlock_alpha();me._controller_slider.logicBlock_alpha();me._gyro.logicBlock_visible();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha();me._autorotate_buttons.logicBlock_visible();me._autorotate_start.logicBlock_alpha();me._autorotate_stop.logicBlock_alpha();me._zoomout.logicBlock_visible();me._zoomin.logicBlock_visible(); });
	player.addListener('configloaded', function(args) { me._float_cursor.logicBlock_visible();me._button_1.logicBlock_position();me._button_1.logicBlock_scaling();me._text_2.logicBlock_position();me._text_2.logicBlock_scaling();me._controller_slider.logicBlock_position();me._controller_slider.logicBlock_scaling();me._gyro.logicBlock_visible();me._text_1.logicBlock_position();me._text_1.logicBlock_scaling();me._text_1_1.logicBlock_position();me._text_1_1.logicBlock_scaling();me._image_3.logicBlock_position();me._image_3.logicBlock_scaling(); });
	...
	player.addListener('varchanged_stertscreen', function(args) { me._meree.logicBlock_visible();me._controller.logicBlock_position(); });
